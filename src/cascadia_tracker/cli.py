                ...
                writer.writerow(
                    {
                        ...
                        "total": result["total"],
                        "winner": game["winner"] == player,
                        "bear_card": game["scoring_cards"]["bear"],
                        "elk_card": game["scoring_cards"]["elk"],
                        "salmon_card": game["scoring_cards"]["salmon"],
                        "hawk_card": game["scoring_cards"]["hawk"],
                        "fox_card": game["scoring_cards"]["fox"],
                        "bear": result["bear"],
                        "elk": result["elk"],
